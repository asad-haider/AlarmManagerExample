...
PrayTimeCalculation.java: Prayer Times Calculator (ver 1.0)
...
public class PrayTimeCalculation {
...
//        PrayTimeCalculation prayers = new PrayTimeCalculation();
//
